...
- Actions: Players can perform actions such as moving,attacking, using items, and interacting with the
environment.
- Inventory: Players can manage their inventory by
adding, removing, and using items. They can also
equip and
